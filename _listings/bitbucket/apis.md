...
- name: Bitbucket Get Repositories Username Repo Slug Downloads Filename
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/downloads/master/_listings/bitbucket/repositories-username-repo-slug-downloads-filename-get-postman.md
x-common:
- type: x-developer
