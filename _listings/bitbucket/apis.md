...
- name: Bitbucket Parameters Repositories Username Repo Slug Downloads Filename
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/downloads/master/_listings/bitbucket/repositories-username-repo-slug-downloads-filename-parameters-postman.md
x-common:
- type: x-developer
