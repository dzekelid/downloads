...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/downloads/master/_listings/aws-rds/apis.md
...
- name: AWS RDS API - Download D B Log File Portion
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/downloads/master/_listings/aws-rds/actiondownloaddblogfileportion-get-openapi.md
- name: AWS RDS API - Download D B Log File Portion
  x-api-slug: actiondownloaddblogfileportion-get
  description: Downloads all or a portion of the specified log file, up to 1 MB in
    size.
